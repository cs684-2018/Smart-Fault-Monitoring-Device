...
const struct mgos_conf_entry mgos_config_schema_[183] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 182},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "app", .num_desc = 2},
  {.type = CONF_TYPE_INT, .key = "interval", .offset = offsetof(struct mgos_config, app.interval)},
  {.type = CONF_TYPE_INT, .key = "led", .offset = offsetof(struct mgos_config, app.led)},
};
